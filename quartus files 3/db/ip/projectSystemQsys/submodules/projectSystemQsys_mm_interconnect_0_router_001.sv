...
(
    ...
    localparam PAD11 = log2ceil(64'hff200010 - 64'hff200000); 
    localparam PAD12 = log2ceil(64'hff200020 - 64'hff200010); 
    ...
    // ( 0xb000000 .. 0xb000400 )
    if ( {address[RG:PAD10],{PAD10{1'b0}}} == 32'hb000000   ) begin
            src_channel = 23'b0000000000000000010000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 12;
    end

    // ( 0xff200000 .. 0xff200010 )
    if ( {address[RG:PAD11],{PAD11{1'b0}}} == 32'hff200000   ) begin
            src_channel = 23'b0000000000000010000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 10;
    end

    // ( 0xff200010 .. 0xff200020 )
    if ( {address[RG:PAD12],{PAD12{1'b0}}} == 32'hff200010   ) begin
