...
(
    ...
    localparam PAD13 = log2ceil(64'hb000400 - 64'hb000000); 
    localparam PAD14 = log2ceil(64'hff200010 - 64'hff200000); 
    localparam PAD15 = log2ceil(64'hff200020 - 64'hff200010); 
    ...
    // ( 0xa000000 .. 0xa000800 )
    if ( {address[RG:PAD12],{PAD12{1'b0}}} == 32'ha000000   ) begin
            src_channel = 23'b00000000000000001000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 8;
    end

    // ( 0xb000000 .. 0xb000400 )
    if ( {address[RG:PAD13],{PAD13{1'b0}}} == 32'hb000000   ) begin
            src_channel = 23'b00000000000000000010000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 11;
    end

    // ( 0xff200000 .. 0xff200010 )
    if ( {address[RG:PAD14],{PAD14{1'b0}}} == 32'hff200000   ) begin
            src_channel = 23'b00000000000000100000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 9;
    end

    // ( 0xff200010 .. 0xff200020 )
    if ( {address[RG:PAD15],{PAD15{1'b0}}} == 32'hff200010   ) begin
